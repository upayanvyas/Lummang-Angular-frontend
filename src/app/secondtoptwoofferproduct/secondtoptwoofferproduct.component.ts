...
@Component({
  selector: 'app-secondtoptwoofferproduct',
  templateUrl: './secondtoptwoofferproduct.component.html',
  styleUrls: ['./secondtoptwoofferproduct.component.css']
})
export class SecondtoptwoofferproductComponent implements OnInit {
  category: any;
  categoryid=0
